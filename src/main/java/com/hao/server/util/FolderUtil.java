...
public class FolderUtil {
	 ...
	 *         指定文件夹的所有父级文件夹列表，以com.hao.server.model.Folder形式封装。
	 */
	...
	private Folder copyFolderByNewNameToPath(Folder prototype, String account, Folder parentFolder, String newName,
		...
		try {
			...
			for (Node n : nodes) {
				Node newNode = fbu.insertNewNode(n.getFileId(), n.getFileName(), account, n.getFilePath(), n.getFileSize(),
