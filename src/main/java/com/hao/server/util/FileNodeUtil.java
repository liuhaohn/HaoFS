...
public class FileNodeUtil {
	...
	public static void initNodeTableToDataBase() {
		Printer.instance.print("Initialize file node...");
		try {
			if (conn == null) {
			...
			Printer.instance.print("File node initialization completed.");
		} catch (Exception e) {
			Printer.instance.print(e.getMessage());
			Printer.instance.print("Initialization error: node file failed.");
		}
	}
