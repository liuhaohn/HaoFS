...
public interface FolderViewService{
	 ...
	 * @param request 请求对象
	 * @return java.lang.String 该文件夹视图的JSON格式，原型详见com.hao.server.pojo.FolderView类。
	 */
    String getFolderViewToJson(final HttpSession session, final HttpServletRequest request);
     ...
     * @return java.lang.String 该文件夹视图的JSON格式，原型详见com.hao.server.pojo.SreachView类。
     */
     ...
     * @return java.lang.String 该文件夹后续视图的JSON格式，原型详见com.hao.server.pojo.RemainingFolderView类。
     */
